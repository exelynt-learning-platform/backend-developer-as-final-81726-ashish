...
public class SecurityConfig {
    ...
    public PasswordEncoder passwordEncoder() {
        // Strength 12 is a reasonable production default (default is 10).
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .csrf(csrf -> csrf.disable()) // safe to disable: stateless, token-based auth, no cookies/sessions
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Tighten this to your actual frontend origin(s) in production.
